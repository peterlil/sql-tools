...
create table #stage (
	...
	[Database File(s) Size (MB)] dec(15,2),
	[Log File Size (MB)] dec(15,2),
	[Unallocated Space (MB)] dec(15,2),
	[Reserved Space (MB)] bigint,
	[Data Space (MB)] bigint,
	[Index Space (MB)] bigint,
	[Unused Space (MB)] bigint,
	[Unused Space (%)] int
);
...
select 
	...
	[Database File(s) Size (MB)] = convert (dec (15,2),@dbsize) * 8192 / 1024 / 1024,
	[Log File Size (MB)] = convert (dec (15,2),@logsize) * 8192 / 1024 / 1024,
	...
	[Reserved (MB)] = @reservedpages * 8192 / 1024. / 1024.,
	[Data (MB)] = @pages * 8192 / 1024. / 1024.,
	[Index (MB)] = (@usedpages - @pages) * 8192 / 1024. / 1024.,
	[Unused (MB)] = (@reservedpages - @usedpages) * 8192 / 1024. / 1024.,
	[Unused (%)] = ROUND(((@reservedpages - @usedpages) * 100 / @reservedpages), 0);';
