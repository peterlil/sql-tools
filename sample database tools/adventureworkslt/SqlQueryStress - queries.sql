...
SELECT c.FirstName, c.LastName, a.StateProvince
...
SELECT soh.SalesOrderNumber, soh.OrderDate, pc.Name AS Category, p.Name AS Product, pm.Name AS Model, pmpd.Culture, pd.Description
...
WHERE pd.Description LIKE '%aluminium%'
