...
INSERT INTO @tmp (Value, Comment)
	SELECT
		...
		CASE 
			WHEN @awe_enabled IS NULL THEN 
				'Information; AWE Enabled is removed in SQL Server 2012.'
...
INSERT INTO @tmp (Value, Comment)
	SELECT
		...
		CASE 
			WHEN @sql_mail_xps IS NULL THEN	
				'Information; SQL Mail XPs is removed in SQL Server 2012.'
